...
<Link href="https://github.com/TankedThomas/ZX80" aria-label="ZX80 Replica GitHub Repo"><ProjectImage src={logo} alt="Sinclair ZX80 Logo" loading="eager" /></Link>
...
<ProjectImage src={schematic} alt="Schematic" />
...
<ProjectImage src={board} alt="WIP PCB" />
...
<ProjectImage src={key} alt="Recreated ZX80 Keypad" />
